...
<div class="section-body">
    <h2 class="section-title">Keranjang Sampah(SPP)</h2>
    ...
    $(document).ready(function() {
        ...
        const toastSuccessPermanentDelete = () => {
            return iziToast.success({
                title: 'Berhasil!'
                , message: 'Data SPP berhasil dihapus permanent!'
                , position: 'topRight'
            })
        }
        const toastSuccessRestore = () => {
            return iziToast.success({
                title: 'Berhasil!'
                , message: 'Data SPP berhasil di restore.'
                , position: 'topRight'
            })
        }
